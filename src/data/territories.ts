...
export const worldLocations: WorldLocation[] = [
  ...
  { id: 'loc-zaragoza', name: 'Saragoça', lat: 41.6488, lon: -0.8891, kind: 'city', terrain: 'plains', ownership: [direct(1137, 'aragon-1500', 1516, 'medium')] },
  { id: 'loc-barcelona', name: 'Barcelona', lat: 41.3874, lon: 2.1686, kind: 'port', terrain: 'coastal', ownership: [direct(1162, 'aragon-1500', 1516, 'medium')] },
  { id: 'loc-paris', name: 'Paris', lat: 48.8566, lon: 2.3522, kind: 'capital', terrain: 'plains', ownership: [direct(987, 'france-1500', 1792, 'medium')] },
  { id: 'loc-london', name: 'Londres', lat: 51.5074, lon: -0.1278, kind: 'capital', terrain: 'coastal', ownership: [direct(927, 'england-1500', 1603, 'medium')] },
  { id: 'loc-edinburgh', name: 'Edimburgo', lat: 55.9533, lon: -3.1883, kind: 'capital', terrain: 'hills', ownership: [direct(1437, 'scotland-1500', 1603, 'medium')] },
  { id: 'loc-vienna-hre', name: 'Viena', lat: 48.2082, lon: 16.3738, kind: 'city', terrain: 'plains', ownership: [direct(1493, 'hre-1500', 1519, 'estimated')] },
  { id: 'loc-nuremberg', name: 'Nuremberg', lat: 49.4521, lon: 11.0767, kind: 'city', terrain: 'plains', ownership: [direct(1493, 'hre-1500', 1519, 'estimated')] },
  ...
  { id: 'loc-cairo', name: 'Cairo', lat: 30.0444, lon: 31.2357, kind: 'capital', terrain: 'desert', ownership: [direct(1250, 'mamluk-1500', 1517, 'medium')] },
  { id: 'loc-damascus', name: 'Damasco', lat: 33.5138, lon: 36.2765, kind: 'city', terrain: 'mixed', ownership: [direct(1260, 'mamluk-1500', 1516, 'medium')] },
  { id: 'loc-moscow', name: 'Moscou', lat: 55.7558, lon: 37.6173, kind: 'capital', terrain: 'forest', ownership: [direct(1283, 'muscovy-1500', 1547, 'medium')] },
  { id: 'loc-krakow', name: 'Cracóvia', lat: 50.0647, lon: 19.9450, kind: 'capital', terrain: 'plains', ownership: [direct(1320, 'poland-1500', 1501, 'medium')] },
  { id: 'loc-vilnius', name: 'Vilnius', lat: 54.6872, lon: 25.2797, kind: 'capital', terrain: 'forest', ownership: [direct(1387, 'lithuania-1500', 1506, 'medium')] },
  ...
  { id: 'loc-delhi', name: 'Délhi', lat: 28.6139, lon: 77.2090, kind: 'capital', terrain: 'plains', ownership: [direct(1451, 'delhi-1500', 1526, 'medium')] },
  { id: 'loc-hampi', name: 'Vijayanagara / Hampi', lat: 15.3350, lon: 76.4600, kind: 'capital', terrain: 'hills', ownership: [direct(1336, 'vijayanagara-1500', 1565, 'medium')] },
  { id: 'loc-ethiopia', name: 'Terras altas etíopes', lat: 11.6000, lon: 38.0000, kind: 'region', terrain: 'mountains', ownership: [direct(1270, 'ethiopia-1500', 1550, 'estimated')] },
  { id: 'loc-gao', name: 'Gao', lat: 16.2717, lon: -0.0447, kind: 'capital', terrain: 'desert', ownership: [direct(1464, 'songhai-1500', 1591, 'medium')] },
  { id: 'loc-mbanza', name: 'Mbanza Kongo', lat: -6.2670, lon: 14.2400, kind: 'capital', terrain: 'forest', ownership: [direct(1390, 'kongo-1500', 1665, 'estimated')] },
  { id: 'loc-tenochtitlan', name: 'Tenochtitlán', lat: 19.4326, lon: -99.1332, kind: 'capital', terrain: 'plains', ownership: [direct(1428, 'aztec-1500', 1521, 'medium')] },
  { id: 'loc-cusco', name: 'Cusco', lat: -13.5319, lon: -71.9675, kind: 'capital', terrain: 'mountains', ownership: [direct(1438, 'inca-1500', 1533, 'medium')] },
